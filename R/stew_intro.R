...
Alibakhshi, S., T. A. Groen, M. Rautiainen and B. Naimi (2017).
          Remotely-sensed early warning signals of a critical transition in a wetland ecosystem. Remote Sensing 9(4): 352-352.")
}
